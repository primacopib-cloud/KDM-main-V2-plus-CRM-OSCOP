...
async def community_board(q: str | None = None):
    ...
    for n in needs:
        ...
        out.append({"reference": n["reference"], "product": n["product"], "quantity": n["quantity"],
                    ...
                    "responder_role": n.get("assigned_role") if n.get("status") in ("VENDOR_ACCEPTED", "OFFER_ACCEPTED") else None,
                    "vendor_price_eur": n.get("vendor_price_eur") if n.get("status") in ("VENDOR_ACCEPTED", "OFFER_ACCEPTED") else None,
                    "vendor_delay_days": n.get("vendor_delay_days") if n.get("status") in ("VENDOR_ACCEPTED", "OFFER_ACCEPTED") else None,
