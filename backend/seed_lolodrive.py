...
async def main():
    ...
    # ---- 4. LOLO POINTS ----
    lolo_points = [
        {"id": "lp-1", "name": "Lolo Point Pointe-à-Pitre", "code": "LP-PAP", "city": "Pointe-à-Pitre", "address": "12 rue Schoelcher", "zone_name": "Grande-Terre", "status": "ACTIVE", "payout_cap_cents_monthly": 120000, "payout_cap_percent_bps": 600, "withdrawal_commission_cents": 70, "pass_activation_commission_cents": 400, "essential_volume_bps": 200},
        {"id": "lp-2", "name": "Lolo Point Capesterre", "code": "LP-CAP", "city": "Capesterre-Belle-Eau", "address": "Place de la Mairie", "zone_name": "Basse-Terre", "status": "ACTIVE", "manager_user_id": "user-gerant-1", "payout_cap_cents_monthly": 120000, "payout_cap_percent_bps": 600, "withdrawal_commission_cents": 70, "pass_activation_commission_cents": 400, "essential_volume_bps": 200},
        {"id": "lp-3", "name": "Lolo Point Gosier", "code": "LP-GOS", "city": "Le Gosier", "address": "Rue Principale", "zone_name": "Grande-Terre", "status": "ACTIVE", "payout_cap_cents_monthly": 120000, "payout_cap_percent_bps": 600, "withdrawal_commission_cents": 70, "pass_activation_commission_cents": 400, "essential_volume_bps": 200},
        {"id": "lp-4", "name": "Lolo Point Saint-François", "code": "LP-STF", "city": "Saint-François", "address": "Marina", "zone_name": "Grande-Terre", "status": "ACTIVE", "payout_cap_cents_monthly": 120000, "payout_cap_percent_bps": 600, "withdrawal_commission_cents": 70, "pass_activation_commission_cents": 400, "essential_volume_bps": 200},
    ]
