...
Découpé : ConnectionManager & helpers dans ws_manager.py.
"""
...
from ws_manager import (
    ConnectionManager, manager, create_notification, send_notification,
    set_ws_manager_database,
)
...
def set_websocket_database(database):
    global db
    db = database
    set_ws_manager_database(database)
