...
from lolodrive_checkout_apply import (
    PASS_PRICE_EUR, PASS_DAYS, PASS_UC, RECHARGE_PACKS,
    _apply_payment_success, _apply_payment_refund, _emit_crm_event,
    _get_or_create_wallet, setup_checkout_indexes,
    set_checkout_apply_database,
)
...
def set_checkout_database(database):
    global db
    db = database
    set_checkout_apply_database(database)
