...
Le fournisseur transmet les documents qualité, origine, douane et conformité requis, ainsi que les poids, volumes, conditionnements et contraintes de transport pour l'organisation logistique LOGI'SCOP."""),
    ("politique-paiement-et-remboursement", "Politique de paiement et de remboursement",
     """Paiements des marchandises et de la logistique : carte bancaire, virement ou solution bancaire habilitée via un prestataire de services de paiement (PSP). CREDI'SCOP : unités internes réservées aux services d'analyse, d'activation et de suivi — jamais un moyen de paiement des produits.
