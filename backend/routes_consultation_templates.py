...
DEFAULT_TEMPLATES = [
    ...
    {"id": "tpl-emballage-enchere", "name": "Emballage / consommables — COOP'ACT",
     ...
     "specs": "Emballages et consommables non alimentaires — COOP'ACT 3 tours (offres améliorables).",
     "max_rounds": 3, "duration_days": 7},
    {"id": "tpl-transport-enchere", "name": "Transport / fret maritime — COOP'ACT",
    ...
    {"id": "tpl-hygiene-enchere", "name": "Hygiène & entretien — COOP'ACT",
