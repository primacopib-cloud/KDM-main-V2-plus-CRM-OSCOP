...
from routes_product_lots import product_lots_router
...
app.include_router(product_lots_router)
...
from routes_logiscop_media_disputes import logiscop_media_router
...
app.include_router(logiscop_media_router)
...
from routes_rar import rar_router, set_rar_database
set_rar_database(db)
...
from routes_member_registry import registry_router, set_registry_database
...
from routes_annual_summary import annual_summary_router, set_annual_summary_database
...
async def startup_db_client():
    ...
    try:
        ...
        logger.warning(f"Could not seed credit packs: {e}")
