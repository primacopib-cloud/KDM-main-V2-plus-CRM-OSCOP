    ...
    <div className="min-h-screen text-white">
      ...
      >
        <div className="max-w-[1160px] mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            >
              <Truck className="w-3 h-3" /> Logistique coopérative
            </span>
            <h1
            ...
            <p className="text-base text-white/80 max-w-[55ch] mb-6">
              ...
              fiabilité maritime/aérienne — au service du PASS Vie Chère.
            </p>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <Stat icon={Package} label="Volumes 2026" value="280 t" tone="bleu" />
              <Stat icon={Clock} label="Délai moyen" value="48 h" tone="orange" />
              <Stat icon={MapPin} label="DOM couverts" value="4" tone="bleu" />
              <Stat icon={ShieldCheck} label="Fiabilité" value="98,2%" tone="orange" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-12">
        <div className="max-w-[1160px] mx-auto">
          <h2 className="text-3xl font-display font-bold text-center mb-10">Un flux, trois étapes</h2>
          <div className="grid md:grid-cols-3 gap-5">
            <Step
              num="01"
              tone="bleu"
              title="Consolidation"
              desc="Agrégation des commandes coopératives sur les 4 territoires DOM. Containerisation maritime mutualisée."
            />
            <Step
              num="02"
              tone="orange"
              title="Acheminement"
              desc="Liaison maritime (Antilles, Réunion) ou aérienne (Guyane). Suivi temps réel via API LOGI'SCOP."
            />
            <Step
              num="03"
              tone="bleu"
              title="Distribution Relais"
              desc="Livraison directe aux relais LOLODRIVE coopératifs. Retrait drive ou livraison locale par O'SCOP."
            />
          </div>
        </div>
      </section>
