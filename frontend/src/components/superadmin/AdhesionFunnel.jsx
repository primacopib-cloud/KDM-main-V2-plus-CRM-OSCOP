...
export const AdhesionFunnel = () => {
  ...
  useEffect(() => {
    fetch(`${API}/vendor-onboarding/admin/funnel`, { headers: getAuthHeaders(), credentials: 'include' })
  ...
  return (
    <div className="glass-panel-soft rounded-[18px] p-4 mb-4" data-testid="adhesion-funnel">
      <h3 className="text-sm font-semibold text-[#D9B35A] flex items-center gap-2 mb-3">
