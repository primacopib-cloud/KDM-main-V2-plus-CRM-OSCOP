...
const SCENES = [
  ...
  ...[
    ...
    duration: 2500, kicker: first ? 'TOUS VOS ESSENTIELS' : '', title: name, sub: '',
  })),
  { video: '/api/uploads/videos/lolospot_order.mp4',
    ...
    duration: 5000, kicker: 'AVEC VOTRE PASS LOLODRIVE', title: 'COMMANDEZ EN LIGNE', sub: 'Depuis chez vous, en quelques clics.' },
  { video: '/api/uploads/videos/lolospot_prep3.mp4',
    ...
    duration: 4000, kicker: 'VOTRE RELAIS PRÉPARE', title: 'VOS PANIERS PRÊTS AVEC SOIN', sub: 'Chaque commande préparée à la main.' },
  { video: '/api/uploads/videos/lolospot_pickup3.mp4',
    ...
    duration: 5000, kicker: 'PRÈS DE CHEZ VOUS', title: 'LIVRAISON OU RETRAIT DRIVE', sub: 'C’est vous qui choisissez à la commande.' },
  { video: '/api/uploads/videos/lolospot_final.mp4',
    ...
    duration: 4000, kicker: 'LOLODRIVE by O’SCOP', title: 'ON VOUS ACCUEILLE AVEC PLAISIR', sub: 'Rejoignez la coopérative dès aujourd’hui.', final: true },
];
