...
const SCENES = [
  ...
  ...[
    ['legumes', 'LÉGUMES DU SOLEIL', true], ['yaourts', 'YAOURTS', false], ['pates', 'PÂTES', false], ['riz', 'RIZ', false],
    ['cereales', 'CÉRÉALES', false], ['huiles', 'HUILES', false], ['beurre', 'BEURRE', false], ['lait', 'LAIT', false],
  ].map(([slug, name, first]) => ({
    video: `/api/uploads/videos/lolospot_prod_${slug}.mp4`,
    img: `/images/spot/prod-${slug}.jpg`,
    imgMobile: `/images/spot/prod-${slug}.jpg`,
    duration: 2500, kicker: first ? 'REMPLISSEZ VOTRE PANIER' : '', title: name,
    sub: first ? 'Et profitez de prix vraiment malins !' : '',
  })),
  { video: '/api/uploads/videos/lolospot_order.mp4',
    ...
    duration: 5000, kicker: 'AVEC VOTRE PASS LOLODRIVE', title: 'COMMANDEZ EN QUELQUES CLICS', sub: 'En ligne ou auprès de votre relais.' },
  { video: '/api/uploads/videos/lolospot_prep3.mp4',
    ...
    duration: 4000, kicker: 'VOTRE RELAIS PRÉPARE', title: 'VOTRE PANIER PRÊT AVEC SOIN', sub: 'Notre équipe s’occupe de tout.' },
  { video: '/api/uploads/videos/lolospot_pickup3.mp4',
    ...
    duration: 5000, kicker: 'C’EST VOUS QUI CHOISISSEZ', title: 'LIVRAISON OU RETRAIT DRIVE', sub: 'Près de chez vous.' },
  { video: '/api/uploads/videos/lolospot_final.mp4',
    ...
    duration: 4000, kicker: 'LOLODRIVE BY O’SCOP', title: 'ACHETEZ PAR TROIS', sub: 'Profitez trois fois plus !', final: true },
];
