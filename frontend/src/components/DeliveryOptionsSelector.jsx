...
// Format currency
import { formatCurrency } from './delivery/deliveryUtils';
import { EssRouteSection } from './delivery/EssRouteSection';
import { StandardDeliverySection } from './delivery/StandardDeliverySection';
  ...
  return (
    <div className="space-y-6">
      ...
      <EssRouteSection
        ...
        essQuote={essQuote}
        essDisclaimer={essDisclaimer}
        availableTours={availableTours}
        selectedTour={selectedTour}
        setSelectedTour={setSelectedTour}
        deliveryAddress={deliveryAddress}
        setDeliveryAddress={setDeliveryAddress}
        essTermsAccepted={essTermsAccepted}
        setEssTermsAccepted={setEssTermsAccepted}
      />
