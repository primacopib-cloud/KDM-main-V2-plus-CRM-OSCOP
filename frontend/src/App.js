...
import PopsLeaderboardPage from "./pages/PopsLeaderboardPage";
...
import FinancingTrackingPage from "./pages/FinancingTrackingPage";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/suivi-financement/:token" element={<FinancingTrackingPage />} />
          ...
          <Route path="/pass" element={<PassLolodrivePage />} />
          ...
          <Route path="/pops" element={<PopsLeaderboardPage />} />
          ...
          <Route path="/encheres/lot/:reference" element={<AuctionLotPage />} />
